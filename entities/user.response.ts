...
export interface createUserDataResponseJson {
    id: number,
    created_at: string,
    updated_at: string,
    name: string,
...
export const createUserDataResponseJsonSchema: JSONSchemaType<createUserDataResponseJson> = {
    type: "object",
    properties: {
        id: { type: "number"},
